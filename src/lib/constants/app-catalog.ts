...
export const APP_CATALOG: AppCatalogEntry[] = [
  ...
  {
    matchNames: ["firework", "firework shoppable video", "firework-shoppable-video-ugc"],
    slug: "firework",
    appStoreSlug: "firework",
    listTitle: "Firework Shoppable Video & UGC",
    developerName: "Firework",
  ...
  {
    matchNames: ["shop sheriff", "shop-sheriff", "amp by shop sheriff"],
    slug: "shop-sheriff-amp",
    appStoreSlug: "amp-google",
    listTitle: "Shop Sheriff AMP Pages",
    developerName: "Shop Sheriff",
  ...
  {
    matchNames: ["chargeflow"],
    slug: "chargeflow",
    appStoreSlug: "chargeflow",
    listTitle: "Chargeflow Prevent Chargebacks",
    developerName: "Chargeflow",
